...
class ValueParameterHandler: public mox::MoxTagHandler
{
public:
	ValueParameterHandler(ForecastCollector & processor, const QString & tagName, const QString & tagNamespace);
